...
- Name: report-form.spec.js >> Hệ Thống Báo Cáo Giao Ban — 11 Khoa Dynamic Forms & Ca Chuyển Viện >> Thêm mới và Xóa ca bệnh chuyển viện cấp cứu linh hoạt
- Location: tests\report-form.spec.js:47:7
...
Locator: locator('button:has-text("Thêm Ca Chuyển Viện")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('button:has-text("Thêm Ca Chuyển Viện")')
