...
const playReportUplinkSuccessSound = () => {
  try {
    ...
    [130.81, 196.00, 261.63, 329.63].forEach((freq, idx) => {
      ...
      gain.gain.linearRampToValueAtTime(0.18 / (idx * 0.3 + 1), now + 0.35);
  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        @keyframes cardPopIn {
          0% { opacity: 0; transform: scale(0.96) translateY(12px); filter: blur(5px); }
      ...
      {/* Main Holographic Telemetry Hub Card (Compact Single-Page Layout) */}
      <div 
        style={{
          width: '100%',
          maxWidth: '880px',
          ...
          borderRadius: '22px',
          boxShadow: '0 15px 50px rgba(15, 44, 89, 0.12), 0 0 0 1px rgba(186, 230, 253, 0.85)',
      ...
      >
        ...
        {/* 1. Holographic Uplink Orbit Sphere & Status */}
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          <div style={{
            ...
            <div style={{
              ...
              inset: '-10px',
              borderRadius: '50%',
              background: 'radial-gradient(circle, rgba(16, 185, 129, 0.3) 0%, rgba(2, 132, 199, 0.12) 50%, transparent 75%)',
              filter: 'blur(10px)',
        ...
        {/* 2. HUD GRID: 4 COMPACT PUSHED DATA METRICS CARDS */}
        <div style={{
          display: 'grid',
          ...
          <div className="hud-stat-pill" style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <span style={{ fontSize: '0.68rem', color: '#0369A1', fontWeight: '800', textTransform: 'uppercase' }}>
                Số Liệu Chuyên Môn
              </span>
              <FaCheckCircle style={{ color: '#0284C7', fontSize: '0.85rem' }} />
            </div>
            <div style={{ fontSize: '1.18rem', fontWeight: '900', color: '#0F2C59' }}>
              Đã Lưu Trữ
            </div>
            <div style={{ fontSize: '0.66rem', color: '#0284C7', fontWeight: '700' }}>
          ...
          <div className="hud-stat-pill" style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <span style={{ fontSize: '0.68rem', color: '#92400E', fontWeight: '800', textTransform: 'uppercase' }}>
                Ca Chuyển Viện
              </span>
              <FaAmbulance style={{ color: '#D97706', fontSize: '0.95rem' }} />
            </div>
            <div style={{ fontSize: '1.18rem', fontWeight: '900', color: '#92400E' }}>
              {transferCases.length} <span style={{ fontSize: '0.78rem', fontWeight: '700' }}>ca bệnh</span>
            </div>
            <div style={{ fontSize: '0.66rem', color: '#B45309', fontWeight: '700' }}>
              {transferCases.length > 0 ? '✓ Đầy đủ diễn biến' : 'Không phát sinh ca chuyển'}
            </div>
          </div>
          ...
          <div className="hud-stat-pill" style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <span style={{ fontSize: '0.68rem', color: '#1E40AF', fontWeight: '800', textTransform: 'uppercase' }}>
                Ca Phẫu Thuật
              </span>
              <FaProcedures style={{ color: '#2563EB', fontSize: '0.95rem' }} />
            </div>
            <div style={{ fontSize: '1.18rem', fontWeight: '900', color: '#1E40AF' }}>
              {surgeryCases.length} <span style={{ fontSize: '0.78rem', fontWeight: '700' }}>ca mổ</span>
            </div>
            <div style={{ fontSize: '0.66rem', color: '#1D4ED8', fontWeight: '700' }}>
              {surgeryCases.length > 0 ? '✓ Chi tiết lệnh mổ' : 'Không có ca phẫu thuật'}
            </div>
          </div>
          ...
          <div className="hud-stat-pill" style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <span style={{ fontSize: '0.68rem', color: '#6B21A8', fontWeight: '800', textTransform: 'uppercase' }}>
                Nặng & Tử Vong
              </span>
              <FaHeartbeat style={{ color: '#9333EA', fontSize: '0.95rem' }} />
            </div>
            <div style={{ fontSize: '1.18rem', fontWeight: '900', color: '#6B21A8' }}>
              {deathCases.length + criticalCases.length} <span style={{ fontSize: '0.78rem', fontWeight: '700' }}>hồ sơ</span>
            </div>
            <div style={{ fontSize: '0.66rem', color: '#7E22CE', fontWeight: '700' }}>
              {deathCases.length} tử vong • {criticalCases.length} theo dõi
            </div>
          </div>
        </div>

        {/* 3. VERIFIED TRANSMISSION DOSSIER HUD CARD */}
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <FaShieldAlt style={{ color: '#0284C7', fontSize: '0.85rem' }} />
            ...
            <div style={{
              ...
              <FaLock style={{ fontSize: '0.6rem' }} /> SSL 256-bit Encrypted
            </div>
          </div>
          ...
          <div style={{
            ...
            <div>
              <span style={{ color: '#64748B', display: 'block', fontSize: '0.68rem', textTransform: 'uppercase', fontWeight: '800' }}>
                Khoa / Khối trực:
              </span>
              <strong style={{ color: '#0F2C59', fontSize: '0.88rem' }}>{departmentName}</strong>
            </div>
            ...
            <div>
              ...
              <strong style={{ color: '#0284C7', fontSize: '0.88rem' }}>{formattedDate}</strong>
            </div>
            ...
            <div>
              ...
              <strong style={{ color: '#1E40AF', fontSize: '0.88rem' }}>{doctorName || '—'}</strong>
            </div>
            ...
            <div>
              ...
              <strong style={{ color: '#059669', fontSize: '0.88rem' }}>{nurseName || '—'}</strong>
            </div>
          </div>
        ...
        {/* 4. ACTION COMMAND BAR (3 BALANCED BUTTONS IN 1 ROW - NO PRESENTATION BUTTON) */}
        <div style={{
          display: 'flex',
          gap: '0.75rem',
          justifyContent: 'center',
          ...
          >
            <FaFilePdf style={{ fontSize: '1.05rem' }} /> XUẤT FILE PDF BÁO CÁO A4
          </button>

          {/* Button 2: Create New Report */}
          <button 
            type="button"
            onClick={onCreateNew}
            style={{
