...
const HoiSucCapCuuForm = ({ doctorName, formData, setFormData, transferCases, setTransferCases }) => {
  ...
  const chuyenVienCount = Number(hscc.chuyenVien) || 0;
  ...
  return (
    <div className="department-form">
      ...
      <div className="form-section">
        ...
        <div className="form-grid">
          <div className="form-group full-width">
            ...
            <input type="number" min="0" step="1" value={hscc.tongSoKham || ''} onChange={(e) => handleHsccChange('tongSoKham', e.target.value)} />
          </div>
          <div className="form-group"><label>Bệnh cũ</label><input type="number" min="0" step="1" value={hscc.benhCu || ''} onChange={(e) => handleHsccChange('benhCu', e.target.value)} /></div>
          <div className="form-group"><label>Bệnh mới</label><input type="number" min="0" step="1" value={hscc.benhMoi || ''} onChange={(e) => handleHsccChange('benhMoi', e.target.value)} /></div>
          <div className="form-group"><label>Xuất viện</label><input type="number" min="0" step="1" value={hscc.xuatVien || ''} onChange={(e) => handleHsccChange('xuatVien', e.target.value)} /></div>
          <div className="form-group"><label>Chuyển viện</label><input type="number" min="0" step="1" value={hscc.chuyenVien || ''} onChange={(e) => handleHsccChange('chuyenVien', e.target.value)} /></div>
      ...
      <div className="form-section">
        ...
        <div className="form-grid">
          <div className="form-group"><label>Bệnh cũ</label><input type="text" value={pk21.pk21_benhCu || ''} onChange={(e) => handlePk21Change('pk21_benhCu', e.target.value)} placeholder="-" /></div>
          <div className="form-group"><label>Bệnh mới</label><input type="text" value={pk21.pk21_benhMoi || ''} onChange={(e) => handlePk21Change('pk21_benhMoi', e.target.value)} placeholder="-" /></div>
          <div className="form-group"><label>Xuất viện</label><input type="text" value={pk21.pk21_xuatVien || ''} onChange={(e) => handlePk21Change('pk21_xuatVien', e.target.value)} placeholder="-" /></div>
          <div className="form-group"><label>Hiện còn</label><input type="text" value={pk21.pk21_hienCon || ''} onChange={(e) => handlePk21Change('pk21_hienCon', e.target.value)} placeholder="-" /></div>
        </div>
        <div className="sub-section" style={{ marginTop: '15px' }}>
          <div className="form-grid">
            <div className="form-group"><label>Tổng số</label><input type="number" min="0" step="1" value={pk21.pk21_tongSo || ''} onChange={(e) => handlePk21Change('pk21_tongSo', e.target.value)} /></div>
            <div className="form-group"><label>Ngoại trú</label><input type="number" min="0" step="1" value={pk21.pk21_ngoaiTru || ''} onChange={(e) => handlePk21Change('pk21_ngoaiTru', e.target.value)} /></div>
          </div>
        </div>
      </div>
    </div>
